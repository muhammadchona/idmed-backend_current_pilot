...
class ProvincialServerControllerSpec extends Specification implements ControllerUnitTest<ProvincialServerController>, DomainUnitTest<ProvincialServer> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new ProvincialServer(params)
        controller.save()
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new ProvincialServer(params)
        instance.id = 1
        instance.version = 0
