...
class StockDestructionAdjustmentControllerSpec extends Specification implements ControllerUnitTest<StockDestructionAdjustmentController>, DomainUnitTest<StockDestructionAdjustment> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new StockDestructionAdjustment(params)
        controller.save()
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new StockDestructionAdjustment(params)
        instance.id = 1
        instance.version = 0
