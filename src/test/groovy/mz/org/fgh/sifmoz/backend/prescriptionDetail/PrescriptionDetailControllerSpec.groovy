...
class PrescriptionDetailControllerSpec extends Specification implements ControllerUnitTest<PrescriptionDetailController>, DomainUnitTest<PrescriptionDetail> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new PrescriptionDetail(params)
        controller.save()
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new PrescriptionDetail(params)
        instance.id = 1
        instance.version = 0
