...
class VisitControllerSpec extends Specification implements ControllerUnitTest<VisitController>, DomainUnitTest<Visit> {
    ...
    void "Test the index action returns the correct response"() {
        given:
        controller.visitService = Mock(VisitService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
