...
class PatientVisitDetailsControllerSpec extends Specification implements ControllerUnitTest<PatientVisitDetailsController>, DomainUnitTest<PatientVisitDetails> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new PatientVisitDetails(params)
        controller.save()
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new PatientVisitDetails(params)
        instance.id = 1
        instance.version = 0
