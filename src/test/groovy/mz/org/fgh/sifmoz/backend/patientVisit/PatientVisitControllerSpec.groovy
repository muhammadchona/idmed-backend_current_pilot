...
class PatientVisitControllerSpec extends Specification implements ControllerUnitTest<PatientVisitController>, DomainUnitTest<PatientVisit> {
    ...
    void "Test the save action correctly persists"() {
        ...
        request.json = new PatientVisit(params)
        controller.save()
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.patientVisitService = Mock(IPatientVisitService) {
            1 * save(_ as PatientVisit) >> { PatientVisit patientVisit ->
                throw new ValidationException("Invalid instance", patientVisit.errors)
            }
        }
    ...
    void "Test the update action correctly persists"() {
        ...
        request.method = 'PUT'
        populateValidParams(params)
        def instance = new PatientVisit(params)
        instance.id = 1
        instance.version = 0
