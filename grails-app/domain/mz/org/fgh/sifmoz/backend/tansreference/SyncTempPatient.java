...
public class SyncTempPatient {
    ...
    private String prescricaoespecial;
    ...
    public Date getDatainiciotarv() {
        return datainiciotarv;
    }

    public void setDatainiciotarv(Date datainiciotarv) {
    ...
    public void setPrescricaoespecial(String prescricaoespecial) {
    ...
    public String toString() {
        return getFirstnames() + " " + getLastname() + " - "+ getPatientid() + " - " + getAddress1() + " "+getClinicname();
    }
}
