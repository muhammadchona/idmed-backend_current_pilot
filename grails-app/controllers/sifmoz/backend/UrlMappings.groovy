...
class UrlMappings {
    ...
    static mappings = {
        ...
        get "/dashBoard/getRegisteredPatientByDispenseType/$year/$clinicId/$serviceCode(.$format)?"(controller:'dashBoard', action:'getRegisteredPatientByDispenseType')
        get "/dashBoard/getPatientsFirstDispenseByGender/$year/$clinicId/$serviceCode(.$format)?"(controller:'dashBoard', action:'getPatientsFirstDispenseByGender')
        get "/dashBoard/getPatientsFirstDispenseByAge/$year/$clinicId/$serviceCode(.$format)?"(controller:'dashBoard', action:'getPatientsFirstDispenseByAge')
        get "/dashBoard/getActivePatientPercentage/$year/$clinicId/$serviceCode(.$format)?"(controller:'dashBoard', action:'getActivePatientPercentage')
        get "/dashBoard/getDispenseByAge/$year/$clinicId/$serviceCode(.$format)?"(controller:'dashBoard', action:'getDispenseByAge')
        get "/dashBoard/getDispensesByGender/$year/$clinicId/$serviceCode(.$format)?"(controller:'dashBoard', action:'getDispensesByGender')
        get "/dashBoard/getStockAlert/$clinicId/$serviceCode(.$format)?"(controller:'dashBoard', action:'getStockAlert')
        get "/dashBoard/getDashboardServiceButton/$year/$clinicId(.$format)?"(controller:'dashBoard', action:'getDashboardServiceButton')
