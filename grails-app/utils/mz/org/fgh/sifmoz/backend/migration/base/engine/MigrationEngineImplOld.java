...
@Service
public class MigrationEngineImplOld<T extends AbstractMigrationRecord> implements MigrationEngine<T> {
    ...
    public MigrationEngineImplOld(AbstractMigrationSearchParams<T> searchParams, String engineType, List<SystemConfigs> systemConfigs) {
        this.searchParams = searchParams;
        this.searchEngine = this.initSearchEngine(searchParams);
        this.engineType = engineType;
        this.systemConfigs = systemConfigs;
        systemConfigsService.getByKey(engineType);
    }
